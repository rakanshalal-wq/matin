...
export const RegisterSchema = z.object({
  ...
  role: z.enum(['owner', 'trainer', 'trainee', 'muhaffiz', 'supervisor', 'caregiver', 'admin', 'teacher', 'parent', 'student'], { error: 'نوع الحساب غير صحيح' }).optional().default('owner'),
  institution_type: z.string().max(50).optional().nullable(),

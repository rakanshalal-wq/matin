...
export default function GradesPage() {
 ...
 <div>
 <h1 className="page-title"><IconRenderer name="ICON_BarChart3" size={18} /> الدرجات والتقييم</h1>
 ...
 <button onClick={() => { setEditItem(null); setShowModal(true); }} style={{ background: GOLD, border: 'none', borderRadius: 10, padding: '10px 20px', color: 'var(--bg)', fontWeight: 700, cursor: 'pointer', fontSize: 14 }}>+ اضافة درجة</button>
 </div>
 </div>
 ...
 { label: 'الراسبون', value: failCount, color: '#EF4444', icon: 'Alert<Triangle size={16} />' },
 ...
 return (
 <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12, background: 'var(--bg-card)', borderRadius: 10, padding: '10px 16px' }}>
 ...
 <button onClick={() => setShowModal(true)} style={{ background: GOLD, border: 'none', borderRadius: 10, padding: '10px 24px', color: 'var(--bg)', fontWeight: 700, cursor: 'pointer', marginTop: 16 }}>+ اضافة اول درجة</button>
 </div>
 ) : (

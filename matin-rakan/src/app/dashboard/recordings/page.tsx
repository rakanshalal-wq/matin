...
export default function RecordingsPage() {
 ...
 <div>
 <h1 className="page-title"><IconRenderer name="ICON_Video" size={18} /> التسجيلات</h1>
 ...
 <div style={{width:44,height:44,borderRadius:10,background:"rgba(107,114,128,0.15)",display:"flex",alignItems:"center",justifyContent:"center"}}><Video size={19} color="#6B7280" /></div>
 ...
 <td style={{ padding: '14px 16px' }}>
 {item.duration ? (
 <span style={{ background: 'rgba(59,130,246,0.1)', color: '#3B82F6', padding: '4px 10px', borderRadius: 8, fontSize: 12, fontWeight: 600 }}>⏱ {item.duration}</span>
 ) : '—'}
 </td>

...
export default function Page(){
 ...
 <div><h1 className="page-title"><IconRenderer name="ICON_Megaphone" size={18} /> الإعلانات</h1><p className="page-sub">إدارة الإعلانات والإشعارات للمجتمع المدرسي</p></div>

...
const DEFAULT_BADGES: Badge[] = [
  { id: '1', label: 'أول جزء', icon: '📖', earned: false },
  { id: '2', label: '5 أجزاء', icon: '⭐', earned: false },
  { id: '3', label: 'الحضور المنتظم', icon: '✅', earned: false },
  { id: '4', label: 'المتفوق', icon: '🏆', earned: false },
  { id: '5', label: 'حافظ القرآن', icon: '🎓', earned: false },
];
                  ...
                  {progress.badges.map(b => (
                    <div key={b.id} style={{ display: 'flex', alignItems: 'center', gap: 12, opacity: b.earned ? 1 : 0.35 }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: 11, color: b.earned ? GOLD : 'rgba(255,255,255,0.25)' }}>{b.earned ? 'مكتسبة ✓' : 'لم تُكتسب بعد'}</div>
                      </div>
                    </div>
                  ))}
                </div>

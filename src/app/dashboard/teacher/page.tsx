...
const initialStudents: { num: number; name: string; status: AttStatus }[] = [
  { num: 1, name: 'أحمد محمد الزهراني', status: 'present' },
  { num: 2, name: 'سارة عبدالله العتيبي', status: 'present' },
  { num: 3, name: 'خالد فهد الشمري', status: 'absent' },
  { num: 4, name: 'نورة سعد الحربي', status: 'present' },
  { num: 5, name: 'عمر علي القحطاني', status: 'late' },
  { num: 6, name: 'ريم محمد المطيري', status: 'present' },
];
...
export default function TeacherPage() {
  ...
  function setStudentStatus(idx: number, status: AttStatus) {
    setStudents((prev) =>
    ...
    <div className="dashboard-page">
      ...
      <aside className={`sidebar${sidebarOpen ? ' open' : ''}`} id="sidebar">
        ...
        <nav className="nav">
          ...
          <a className="nav-item active" href="#" onClick={() => { if (window.innerWidth <= 768) closeSb(); }}>
          ...
          <a className="nav-item" href="#" onClick={() => { if (window.innerWidth <= 768) closeSb(); }}>
        ...
        <div className="content">
            ...
            <div className="card">
              <div className="card-hdr">
                ...
                <div style={{ display: 'flex', gap: '6px', alignItems: 'center' }}>
                  ...
                  <button className="card-link" onClick={() => {}}>حفظ</button>
                </div>
              </div>
              {/* Summary bar */}
              <div style={{ display: 'flex', gap: 0, borderBottom: '1px solid var(--border2)' }}>
                <div style={{ flex: 1, padding: '8px 12px', textAlign: 'center', borderLeft: '1px solid var(--border2)' }}>
                  <div style={{ fontSize: '18px', fontWeight: 800, color: 'var(--accent)' }}>{presentCount}</div>
                  <div style={{ fontSize: '10px', color: 'var(--text-muted)' }}>حاضر</div>
                </div>
                <div style={{ flex: 1, padding: '8px 12px', textAlign: 'center', borderLeft: '1px solid var(--border2)' }}>
                  <div style={{ fontSize: '18px', fontWeight: 800, color: 'var(--red)' }}>{absentCount}</div>
                  <div style={{ fontSize: '10px', color: 'var(--text-muted)' }}>غائب</div>
                </div>
                <div style={{ flex: 1, padding: '8px 12px', textAlign: 'center' }}>
                  <div style={{ fontSize: '18px', fontWeight: 800, color: 'var(--orange)' }}>{lateCount}</div>
                  <div style={{ fontSize: '10px', color: 'var(--text-muted)' }}>متأخر</div>
                </div>
              </div>
              <div style={{ maxHeight: '200px', overflowY: 'auto' }}>
                {students.map((student, idx) => (
                  <div className="att-student" key={student.num}>
                    <div className="att-num">{student.num}</div>
                    <div className="att-name">{student.name}</div>
                    <div className="att-btns">
                      <button
                        className={`att-btn att-present${student.status === 'present' ? ' selected-p' : ''}`}
                        title="حاضر"
                        onClick={() => setStudentStatus(idx, 'present')}
                      >✓</button>
                      <button
                        className={`att-btn att-absent${student.status === 'absent' ? ' selected-a' : ''}`}
                        title="غائب"
                        onClick={() => setStudentStatus(idx, 'absent')}
                      >✗</button>
                      <button
                        className={`att-btn att-late${student.status === 'late' ? ' selected-l' : ''}`}
                        title="متأخر"
                        onClick={() => setStudentStatus(idx, 'late')}
                      >⏰</button>
                    </div>
                  </div>
                ))}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <div className="card">
                <div className="card-hdr">
                  ...
                  <button className="card-link" style={{ color: 'var(--orange)' }} onClick={() => {}}>الكل</button>
                </div>
                <div>
                  <div className="hw-item">
                    ...
                    <button className="btn-sm" style={{ background: 'rgba(251,146,60,0.08)', color: 'var(--orange)', border: '1px solid rgba(251,146,60,0.2)' }} onClick={() => {}}>تصحيح</button>
                  </div>
                  <div className="hw-item">
                  ...
                  <div className="hw-item" style={{ borderBottom: 'none' }}>
                    ...
                    <button className="btn-sm" style={{ background: 'rgba(74,222,128,0.08)', color: 'var(--accent)', border: '1px solid rgba(74,222,128,0.2)' }} onClick={() => {}}>جديد</button>
                  </div>
                </div>
              </div>
              ...
              <div className="card">
                <div className="card-hdr">
                  ...
                  <button className="card-link" style={{ color: 'var(--blue)' }} onClick={() => {}}>الكل</button>
                </div>
                <div>
                  <div className="msg-item" onClick={() => {}}>
                  ...
                  <div className="msg-item" style={{ borderBottom: 'none' }} onClick={() => {}}>
          ...
          <div className="grid-3">
            ...
            <div className="card">
              <div className="card-hdr">
                ...
                <button className="card-link" style={{ color: 'var(--purple)' }} onClick={() => {}}>تعديل</button>
              </div>
              <div className="tbl-wrap">
                <table>
                  <thead>
                    <tr><th>الطالب</th><th>الدرجة</th><th>التقدير</th></tr>
                  </thead>
                  <tbody>
            ...
            <div className="card">
              <div className="card-hdr">
                ...
                <button className="card-link" style={{ color: 'var(--blue)' }} onClick={() => {}}>إضافة</button>
              </div>
              <div>
              ...
              <div style={{ padding: '12px 14px', borderTop: '1px solid var(--border2)' }}>
                <button className="btn-primary" style={{ width: '100%', justifyContent: 'center', fontSize: '12px', padding: '8px' }} onClick={() => {}}>
          ...
          <div style={{ marginBottom: '6px' }}>
            ...
            <div className="quick-grid">
              <a className="quick-item" href="#" onClick={(e) => e.preventDefault()}>

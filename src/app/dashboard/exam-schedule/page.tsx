...
export default function Page(){
 ...
 <div><h1 className="page-title"><IconRenderer name="ICON_ClipboardList" size={18} /> جدول الاختبارات</h1><p className="page-sub">إدارة جداول الاختبارات والامتحانات</p></div>

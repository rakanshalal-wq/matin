'use client';
import { AlertTriangle, Banknote, CheckCircle, Coins, Download, X } from "lucide-react";
    ...
    <div style={{ minHeight: '100vh', background: BG, padding: '32px 24px', direction: 'rtl', fontFamily: 'Cairo, sans-serif' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 16, marginBottom: 28 }}>
        {[
          ...
          { label: 'متاخرو الدفع', value: overdueCount, color: '#F59E0B', icon: 'AlertTriangle<IconRenderer name="ICON_Star" size={18} />' },
        ].map((s, i) => (
      ...
      <div style={{ background: CARD_BG, border: '1px solid ' + BORDER, borderRadius: 16, overflow: 'hidden' }}>
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: 60 }}>
            <div style={{ fontSize: 48, marginBottom: 16 }}><IconRenderer name="ICON_Coins" size={36} /></div>

...
export default function StudentFeesPage() {
 ...
 if (!form.student_name || !form.amount) return showError('ادخل البيانات المطلوبة');
 setSaving(true);
 try {
 ...
 fetchFees();
 showSuccess(editItem ? 'تم تحديث الرسوم بنجاح' : 'تم إضافة الرسوم بنجاح');
 } else { const e = await res.json(); showError(e.error || 'فشل الحفظ'); }

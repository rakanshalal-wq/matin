...
export default function Page(){
 ...
 <div><h1 className="page-title"><IconRenderer name="ICON_Pin" size={18} /> تعيينات المعلمين</h1><p className="page-sub">إدارة تعيين المعلمين للفصول والمواد</p></div>

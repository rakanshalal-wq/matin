export default function Dashboard() {
  const stats = [{"label":"دوراتي","color":"#FB923C","value":"5"},{"label":"المتدربون","color":"#F97316","value":"120"},{"label":"التقييم","color":"#10B981","value":"4.8"},{"label":"الدخل","color":"#D4A843","value":"8,500"}];
  return (
      ...
      \u003caside style={{ width: 260, flexShrink: 0, height: '100vh', background: '#08081A', borderLeft: '1px solid rgba(255,255,255,0.07)', display: 'flex', flexDirection: 'column' }}>
        ...
        \u003cnav style={{ flex: 1, padding: '6px 0' }}\u003e
          {['النظرة العامة', 'الدورات', 'المتدربون', 'الجدول', 'الشهادات'].map((item, i) => (
            \u003cdiv key={i} style={{ padding: '8px 16px', fontSize: 12, color: i === 0 ? '#EEEEF5' : 'rgba(238,238,245,0.55)', cursor: 'pointer', borderRight: i === 0 ? '3px solid #EA580C' : 'none', background: i === 0 ? '#EA580C20' : 'transparent' }}\u003e{item}\u003c/div\u003e
          ))}
        \u003c/nav\u003e
      \u003c/aside\u003e
      \u003cmain style={{ flex: 1, padding: 24 }}\u003e
        \u003ch1 style={{ fontSize: 24, fontWeight: 800, color: '#EA580C', marginBottom: 24 }}\u003eلوحة المدرب\u003c/h1\u003e

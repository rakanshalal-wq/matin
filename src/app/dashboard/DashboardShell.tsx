...
export default function DashboardShell({
 ...
 if (!pathname.includes('website-content')) {
 router.push('/owner');
 return;
 }
 }
 ...
 <div style={{ width: 80, height: 80, background: 'linear-gradient(135deg, #D4A843 0%, #E2C46A 100%)', borderRadius: 20, margin: '0 auto 24px', animation: 'pulse 2s infinite', boxShadow: '0 0 40px rgba(201,168,76,0.2)' }} />
 <p style={{ color: '#D4A843', fontSize: 20, fontWeight: 700, letterSpacing: -0.5 }}>جاري تحميل متين...</p>

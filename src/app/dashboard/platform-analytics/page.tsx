...
export default function PlatformAnalyticsPage() {
  ...
  const cards = stats ? [
    ...
    { label: 'إجمالي الطلاب', value: stats.students || 0, icon: 'User‍GraduationCap', color: '#3B82F6' },
    { label: 'إجمالي المعلمين', value: stats.teachers || 0, icon: 'User‍School', color: '#10B981' },
    { label: 'المستخدمون النشطون', value: stats.active_users || 0, icon: "ICON_CheckCircle", color: '#06B6D4' },
  ...
  return (
    <div style={{ padding: 24, background: '#06060E', minHeight: '100vh', fontFamily: 'Arial' }} dir="rtl">
      <div style={{ marginBottom: 24, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <h1 style={{ color: '#C9A227', fontSize: 24, fontWeight: 800, margin: 0 }}>BarChart3 إحصاءات المنصة</h1>
        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            ...
            <div style={{ background: 'rgba(255,255,255,0.04)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.08)', padding: 20 }}>
              <h3 style={{ color: 'white', margin: '0 0 16px 0', fontSize: 16 }}>Diamond توزيع الباقات</h3>
              {[
            ...
            {/* القواعد الذهبية */}
            <div style={{ background: 'rgba(255,255,255,0.04)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.08)', padding: 20 }}>
              <h3 style={{ color: 'white', margin: '0 0 16px 0', fontSize: 16 }}>Trophy القواعد الذهبية</h3>
              {[
                ...
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 0', borderBottom: i < 5 ? '1px solid rgba(255,255,255,0.06)' : 'none' }}>
                  <span style={{ color: '#10B981', fontSize: 16 }}>CheckCircle</span>
            ...
            <div style={{ background: 'rgba(255,255,255,0.04)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.08)', padding: 20, gridColumn: '1 / -1' }}>
              <h3 style={{ color: 'white', margin: '0 0 16px 0', fontSize: 16 }}>Zap روابط سريعة</h3>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12 }}>
                {[
                  { label: 'إدارة المدارس', href: '/dashboard/schools', icon: "ICON_School" },
                  { label: 'المستخدمون', href: '/dashboard/users', icon: "ICON_Users" },
                  { label: 'الاشتراكات', href: '/dashboard/subscriptions', icon: "ICON_Diamond" },
                  { label: 'سجل العمليات', href: '/dashboard/activity-log', icon: "ICON_ClipboardList" },
                  { label: 'مفاتيح الطوارئ', href: '/dashboard/emergency-keys', icon: 'KeyRound️' },
                  { label: 'الدعم الفني', href: '/dashboard/support', icon: "ICON_Headphones" },
                  { label: 'النسخ الاحتياطي', href: '/dashboard/backup', icon: "ICON_Save" },
                  { label: 'سجل الأخطاء', href: '/dashboard/error-logs', icon: "ICON_Bug" },
                ].map((link, i) => (

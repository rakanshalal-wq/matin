...
export default function PlatformAnalyticsPage() {
  ...
  const cards = stats ? [
    ...
    { label: 'إجمالي الطلاب', value: stats.students || 0, icon: 'User<IconRenderer name="ICON_Star" size={18} />GraduationCap', color: '#3B82F6' },
    { label: 'إجمالي المعلمين', value: stats.teachers || 0, icon: 'User<IconRenderer name="ICON_Star" size={18} />School', color: '#10B981' },
      ...
      {loading ? (
        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            ...
            {/* القواعد الذهبية */}
            <div style={{ background: 'rgba(255,255,255,0.04)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.08)', padding: 20 }}>
              <h3 style={{ color: 'white', margin: '0 0 16px 0', fontSize: 16 }}><IconRenderer name="ICON_Trophy" size={18} /> القواعد الذهبية</h3>
              {[
            ...
            <div style={{ background: 'rgba(255,255,255,0.04)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.08)', padding: 20, gridColumn: '1 / -1' }}>
              <h3 style={{ color: 'white', margin: '0 0 16px 0', fontSize: 16 }}><IconRenderer name="ICON_Zap" size={18} /> روابط سريعة</h3>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12 }}>
                {[
                  ...
                  { label: 'مفاتيح الطوارئ', href: '/dashboard/emergency-keys', icon: 'KeyRound<IconRenderer name="ICON_Star" size={18} />' },

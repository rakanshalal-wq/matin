export default function Dashboard() {
  const stats = [{"label":"المهام","color":"#60A5FA","value":"12"},{"label":"الاجتماعات","color":"#A78BFA","value":"3"},{"label":"الطلبات","color":"#10B981","value":"5"},{"label":"التقارير","color":"#D4A843","value":"8"}];
  return (
    \u003cdiv dir="rtl" style={{ fontFamily: "'IBM Plex Sans Arabic', sans-serif", background: '#06060E', color: '#EEEEF5', minHeight: '100vh', display: 'flex' }}>
      ...
      \u003cmain style={{ flex: 1, padding: 24 }}\u003e
        \u003ch1 style={{ fontSize: 24, fontWeight: 800, color: '#60A5FA', marginBottom: 24 }}\u003eلوحة الموظفين\u003c/h1\u003e

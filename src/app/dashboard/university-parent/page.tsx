export default function Dashboard() {
  const stats = [{"label":"الأبناء","color":"#3B82F6","value":"2"},{"label":"المعدل التراكمي","color":"#10B981","value":"3.8"},{"label":"الساعات المنجزة","color":"#60A5FA","value":"85"},{"label":"الرسوم","color":"#D4A843","value":"15K"}];
  return (
    \u003cdiv dir="rtl" style={{ fontFamily: "'IBM Plex Sans Arabic', sans-serif", background: '#06060E', color: '#EEEEF5', minHeight: '100vh', display: 'flex' }}>
      ...
      \u003cmain style={{ flex: 1, padding: 24 }}\u003e
        \u003ch1 style={{ fontSize: 24, fontWeight: 800, color: '#3B82F6', marginBottom: 24 }}\u003eبوابة ولي الأمر الجامعي\u003c/h1\u003e

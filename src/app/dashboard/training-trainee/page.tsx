export default function Dashboard() {
  const stats = [{"label":"دوراتي","color":"#FB923C","value":"3"},{"label":"التقدم","color":"#10B981","value":"65%"},{"label":"الشهادات","color":"#D4A843","value":"2"},{"label":"الساعات","color":"#60A5FA","value":"45"}];
  return (
      ...
      \u003caside style={{ width: 260, flexShrink: 0, height: '100vh', background: '#08081A', borderLeft: '1px solid rgba(255,255,255,0.07)', display: 'flex', flexDirection: 'column' }}>
        ...
        \u003cnav style={{ flex: 1, padding: '6px 0' }}\u003e
          {['النظرة العامة', 'الدورات', 'المتدربون', 'الجدول', 'الشهادات'].map((item, i) => (
            \u003cdiv key={i} style={{ padding: '8px 16px', fontSize: 12, color: i === 0 ? '#EEEEF5' : 'rgba(238,238,245,0.55)', cursor: 'pointer', borderRight: i === 0 ? '3px solid #F97316' : 'none', background: i === 0 ? '#F9731620' : 'transparent' }}\u003e{item}\u003c/div\u003e
          ))}
        \u003c/nav\u003e
      \u003c/aside\u003e
      \u003cmain style={{ flex: 1, padding: 24 }}\u003e
        \u003ch1 style={{ fontSize: 24, fontWeight: 800, color: '#F97316', marginBottom: 24 }}\u003eبوابة المتدرب\u003c/h1\u003e

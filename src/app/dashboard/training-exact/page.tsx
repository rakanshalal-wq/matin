...
// ═══════════════════════════════════════════════════════════════
// لوحة مركز التدريب - بالضبط كما في الملف الأصلي
// ═══════════════════════════════════════════════════════════════
...
export default function TrainingDashboard() {
  ...
  const styles = `
    :root {
      --primary:#FB923C; --primary2:#EA580C;
      --primary-dim:rgba(251,146,60,0.1); --primary-border:rgba(251,146,60,0.22);
      --gold:#D4A843;
    ...
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .admin-av{width:32px;height:32px;border-radius:8px;background:rgba(251,146,60,0.15);border:1px solid var(--primary-border);display:flex;align-items:center;justify-content:center;font-size:16px;}
    ...
    .user-av{width:28px;height:28px;border-radius:7px;background:rgba(251,146,60,0.1);border:1.5px solid rgba(251,146,60,0.3);display:flex;align-items:center;justify-content:center;font-size:14px;}
      ...
      <div style={{ fontFamily: 'IBM Plex Sans Arabic, sans-serif', background: '#06060E', color: '#EEEEF5', height: '100vh', overflow: 'hidden', display: 'flex' }}>
          ...
          \u003cdiv className="sb-top">
            \u003ca href="/" className="logo">
              ...
              \u003cdiv>
                ...
                \u003cdiv className="logo-sub">مركز الإبداع\u003c/div>
              \u003c/div>
            \u003c/a>
        ...
        \u003cmain className="main">
          ...
          \u003cheader className="header">
            \u003cdiv>
              \u003cdiv className="hdr-title">لوحة مركز التدريب\u003c/div>

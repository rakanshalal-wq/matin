...
export default function Page(){
 ...
 <div><h1 style={{fontSize:28,fontWeight:800,color:'white',margin:0}}><IconRenderer name="ICON_User" size={18} />s لجان التصحيح</h1><p style={{color:'rgba(255,255,255,0.5)',marginTop:6,fontSize:14}}>إدارة لجان تصحيح الاختبارات</p></div>
 ...
 <div key={'إجمالي اللجان'} style={{background:CB,border:'1px solid '+BR,borderRadius:14,padding:'18px 20px'}}><div style={{fontSize:26,fontWeight:800,color:'#C9A84C'}}>{loading?'...':items.length}</div><div style={{fontSize:13,color:'rgba(255,255,255,0.5)',marginTop:4}}>إجمالي اللجان</div></div><div key={'نشطة'} style={{background:CB,border:'1px solid '+BR,borderRadius:14,padding:'18px 20px'}}><div style={{fontSize:26,fontWeight:800,color:'#10B981'}}>{loading?'...':items.filter((r:any)=>r.status==='نشطة').length}</div><div style={{fontSize:13,color:'rgba(255,255,255,0.5)',marginTop:4}}>نشطة</div></div><div key={'منتهية'} style={{background:CB,border:'1px solid '+BR,borderRadius:14,padding:'18px 20px'}}><div style={{fontSize:26,fontWeight:800,color:'#6B7280'}}>{loading?'...':items.filter((r:any)=>r.status==='منتهية').length}</div><div style={{fontSize:13,color:'rgba(255,255,255,0.5)',marginTop:4}}>منتهية</div></div><div key={'ملغاة'} style={{background:CB,border:'1px solid '+BR,borderRadius:14,padding:'18px 20px'}}><div style={{fontSize:26,fontWeight:800,color:'#EF4444'}}>{loading?'...':items.filter((r:any)=>r.status==='ملغاة').length}</div><div style={{fontSize:13,color:'rgba(255,255,255,0.5)',marginTop:4}}>ملغاة</div></div>
 </div>

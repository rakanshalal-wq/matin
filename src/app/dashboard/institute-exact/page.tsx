...
export default function InstituteDashboard() {
  ...
  const stats = [
    { icon: '📚', value: '12', label: 'البرامج', color: '#A78BFA', bg: 'rgba(167,139,250,0.15)' },
    { icon: '👨‍🎓', value: '280', label: 'المتدربون', color: '#8B5CF6', bg: 'rgba(139,92,246,0.15)' },
    { icon: '👨‍🏫', value: '15', label: 'المدربون', color: '#7C3AED', bg: 'rgba(124,58,237,0.15)' },
    { icon: '🏆', value: '8', label: 'الدورات النشطة', color: '#D4A843', bg: 'rgba(212,168,67,0.15)' },
  ];

...
// ═══════════════════════════════════════════════════════════════
// لوحة المعهد - بالضبط كما في الملف الأصلي
// ═══════════════════════════════════════════════════════════════
...
export default function InstituteDashboard() {
  ...
  const styles = `
    ...
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .admin-av{width:32px;height:32px;border-radius:8px;background:rgba(167,139,250,0.15);border:1px solid var(--primary-border);display:flex;align-items:center;justify-content:center;font-size:16px;}
  ...
  const navItems = [
    ...
    { id: 'programs', label: 'البرامج', icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20 M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg> },
  ...
  const stats = [
    { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20 M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>, value: '12', label: 'البرامج', color: '#A78BFA', bg: 'rgba(167,139,250,0.15)' },
    { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z M6 12v5c3 3 9 3 12 0v-5"/></svg>, value: '280', label: 'المتدربون', color: '#8B5CF6', bg: 'rgba(139,92,246,0.15)' },
    { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2 M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z"/></svg>, value: '15', label: 'المدربون', color: '#7C3AED', bg: 'rgba(124,58,237,0.15)' },
    { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#D4A843" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6 M18 9h1.5a2.5 2.5 0 0 0 0-5H18 M4 22h16 M18 2H6v7a6 6 0 0 0 12 0V2z"/></svg>, value: '8', label: 'الدورات النشطة', color: '#D4A843', bg: 'rgba(212,168,67,0.15)' },
  ];
      ...
      <div dir="rtl" style={{ fontFamily: 'IBM Plex Sans Arabic, sans-serif', background: '#06060E', color: '#EEEEF5', height: '100vh', overflow: 'hidden', display: 'flex' }}>
          ...
          <div className="sb-top">
            <a href="/" className="logo">
              ...
              <div>
                ...
                <div className="logo-sub">معهد الإتقان</div>
              </div>
            </a>
            <div className="admin-card">
              ...
              <div>
                <div className="admin-name">م. سعد العنزي</div>
                <div className="admin-role">مدير المعهد</div>
              </div>
            </div>
          </div>
        ...
        <main className="main">
          ...
          <header className="header">
            <div>
              <div className="hdr-title">لوحة المعهد</div>
            ...
            <div className="user-btn">
              ...
              <div style={{ fontSize: '12px', fontWeight: 700 }}>م. سعد</div>
            </div>
          </header>

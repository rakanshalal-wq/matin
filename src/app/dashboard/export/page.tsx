...
export default function ExportPage() {
 ...
 { id: 'students', title: 'بيانات الطلاب', description: 'تصدير قائمة الطلاب مع معلوماتهم الكاملة', icon: '<User size={16} />GraduationCap', formats: ['csv', 'xlsx', 'pdf'] },
 { id: 'teachers', title: 'بيانات المعلمين', description: 'تصدير قائمة المعلمين والموظفين', icon: '<User size={16} />School', formats: ['csv', 'xlsx', 'pdf'] },
 ...
 <h3 style={{ margin: '0 0 20px', fontSize: '18px', color: '#1e3a5f' }}>إعدادات التصدير</h3>

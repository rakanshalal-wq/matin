...
export default function CollegesPage() {
  ...
  function openPermModal(name: string, role: string) {
    setPermStaffName(name);
    setPermStaffRole(role);
  ...
  return (
    <div className="page">
      ...
      {/* OVERLAY */}
      <div className={'overlay' + (sidebarOpen ? ' show' : '')} id="overlay" onClick={() => closeSb()}></div>

      {/* PERMISSIONS MODAL */}
      <div className={'modal-overlay' + (permModalOpen ? ' show' : '')} id="perm-modal">
        <div className="modal">
          <div className="modal-hdr">
            <div className="modal-title">
              ...
              صلاحيات <span>{permStaffName}</span>
            </div>
          ...
          <div style={{padding:'14px'}}>
            <div style={{background:'rgba(167,139,250,0.06)',border:'1px solid var(--accent-border)',borderRadius:'8px',padding:'10px 14px',marginBottom:'14px',fontSize:'12px',color:'var(--text-dim)'}}>
              <strong style={{color:'var(--accent)'}}>الدور الحالي:</strong> <span>{permStaffRole}</span>
            </div>
      ...
      <aside className={'sidebar' + (sidebarOpen ? ' open' : '')} id="sidebar">
        ...
        <nav className="nav">
          ...
          <a className="ni" href="#" style={{color:'var(--accent)',fontWeight:600}} onClick={(e) => { e.preventDefault(); openPermModal('الكل',''); }}>

...
import { ClipboardList, School, Search, X } from "lucide-react";
...
export default function Page() {
 ...
 const url = editItem ? '/api/facilities?id=' + editItem.id : '/api/facilities';
 ...
 try { await fetch('/api/facilities?id=' + id, { method: 'DELETE', headers: getHeaders() }); fetchItems(); } catch { }
 };
 ...
 <div>
 <h1 style={{ fontSize: 28, fontWeight: 800, color: 'white', margin: 0 }}><IconRenderer name="ICON_School" size={18} /> المرافق والمباني</h1>
 <p style={{ color: 'rgba(255,255,255,0.5)', marginTop: 6, fontSize: 14 }}>إدارة مرافق وأصول المدرسة</p>
 </div>
 ...
 <h2 style={{ color: 'white', fontSize: 20, fontWeight: 700, margin: 0 }}>{editItem ? 'تعديل' : 'اضافة جديد'} — المرافق والمباني</h2>

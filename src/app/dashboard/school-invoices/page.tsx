...
export default function Page(){
 ...
 <div><h1 style={{fontSize:28,fontWeight:800,color:'white',margin:0}}><IconRenderer name="ICON_FileText" size={18} /> فواتير المدارس</h1><p style={{color:'rgba(255,255,255,0.5)',marginTop:6,fontSize:14}}>إدارة فواتير الاشتراك والخدمات للمدارس</p></div>

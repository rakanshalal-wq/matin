...
export default function Page(){
 ...
 <div><h1 style={{fontSize:28,fontWeight:800,color:'white',margin:0}}><IconRenderer name="ICON_GraduationCap" size={18} /> المدربون الخارجيون</h1><p style={{color:'rgba(255,255,255,0.5)',marginTop:6,fontSize:14}}>إدارة المدربين الخارجيين والمحاضرين الزائرين</p></div>
 ...
 <div key={'إجمالي المدربين'} style={{background:CB,border:'1px solid '+BR,borderRadius:14,padding:'18px 20px'}}><div style={{fontSize:26,fontWeight:800,color:'#C9A84C'}}>{loading?'...':items.length}</div><div style={{fontSize:13,color:'rgba(255,255,255,0.5)',marginTop:4}}>إجمالي المدربين</div></div><div key={'مجدولون'} style={{background:CB,border:'1px solid '+BR,borderRadius:14,padding:'18px 20px'}}><div style={{fontSize:26,fontWeight:800,color:'#3B82F6'}}>{loading?'...':items.filter((r:any)=>r.status==='مجدول').length}</div><div style={{fontSize:13,color:'rgba(255,255,255,0.5)',marginTop:4}}>مجدولون</div></div><div key={'جاري'} style={{background:CB,border:'1px solid '+BR,borderRadius:14,padding:'18px 20px'}}><div style={{fontSize:26,fontWeight:800,color:'#10B981'}}>{loading?'...':items.filter((r:any)=>r.status==='جاري').length}</div><div style={{fontSize:13,color:'rgba(255,255,255,0.5)',marginTop:4}}>جاري</div></div><div key={'منتهون'} style={{background:CB,border:'1px solid '+BR,borderRadius:14,padding:'18px 20px'}}><div style={{fontSize:26,fontWeight:800,color:'#6B7280'}}>{loading?'...':items.filter((r:any)=>r.status==='منتهي').length}</div><div style={{fontSize:13,color:'rgba(255,255,255,0.5)',marginTop:4}}>منتهون</div></div>
 </div>

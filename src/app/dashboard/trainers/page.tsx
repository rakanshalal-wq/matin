...
export default function Page(){
 ...
 <div><h1 className="page-title"><IconRenderer name="ICON_GraduationCap" size={18} /> المدربون الخارجيون</h1><p className="page-sub">إدارة المدربين الخارجيين والمحاضرين الزائرين</p></div>

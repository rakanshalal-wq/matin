...
export default function ComplaintsPage() {
 ...
 <div>
 <h1 className="page-title"><IconRenderer name="ICON_FileText" size={18} /> الشكاوى والاقتراحات</h1>
 ...
 {[
 { label: 'الإجمالي', value: stats.total, icon: "ICON_FileText", color: 'var(--gold)' },
 ...
 <td style={{ padding: '14px 16px', color: item.assigned_to ? '#D4A843' : 'rgba(255,255,255,0.3)', fontWeight: item.assigned_to ? 600 : 400, fontSize: 13 }}>{item.assigned_to || 'غير محدد'}</td>
 <td style={{ padding: '14px 16px' }}>

...
export default function Page(){
 ...
 <div><h1 className="page-title"><IconRenderer name="ICON_FileText" size={18} /> طلبات القبول</h1><p className="page-sub">إدارة طلبات التسجيل والقبول للطلاب الجدد</p></div>

...
export default function Page() {
 ...
 <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ fontSize: 28 }}><IconRenderer name="ICON_Palette" size={36} /></span><span style={{ fontSize: 28, fontWeight: 800, color: '#D4A843' }}>{items.length}</span></div>

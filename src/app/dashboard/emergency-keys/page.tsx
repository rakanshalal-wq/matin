...
export default function Page(){
 ...
 <div><h1 className="page-title"><IconRenderer name="ICON_Key" size={18} /> مفاتيح الطوارئ</h1><p className="page-sub">إدارة مفاتيح الوصول للطوارئ والأنظمة الحيوية</p></div>

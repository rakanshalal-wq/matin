...
export default function AttendancePage() {
 ...
 <div>
 <h1 className="page-title"><IconRenderer name="ICON_ClipboardList" size={18} /> الحضور والغياب</h1>
 ...
 <button onClick={() => { setEditItem(null); setShowModal(true); }} style={{ background: GOLD, border: 'none', borderRadius: 10, padding: '10px 20px', color: 'var(--bg)', fontWeight: 700, cursor: 'pointer', fontSize: 14 }}>+ تسجيل حضور</button>
 </div>
 </div>
 ...
 <button onClick={() => setShowModal(true)} style={{ background: GOLD, border: 'none', borderRadius: 10, padding: '10px 24px', color: 'var(--bg)', fontWeight: 700, cursor: 'pointer', marginTop: 16 }}>+ تسجيل اول حضور</button>
 </div>
 ) : (

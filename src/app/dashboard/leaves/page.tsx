...
export default function Page(){
 ...
 <div><h1 style={{fontSize:28,fontWeight:800,color:'white',margin:0}}>Palmtree الإجازات والغيابات</h1><p style={{color:'rgba(255,255,255,0.5)',marginTop:6,fontSize:14}}>إدارة طلبات الإجازات للمعلمين والموظفين</p></div>
 ...
 <div key={'إجمالي الطلبات'} style={{background:CB,border:'1px solid '+BR,borderRadius:14,padding:'18px 20px'}}><div style={{fontSize:26,fontWeight:800,color:'#C9A84C'}}>{loading?'...':items.length}</div><div style={{fontSize:13,color:'rgba(255,255,255,0.5)',marginTop:4}}>إجمالي الطلبات</div></div><div key={'معلقة'} style={{background:CB,border:'1px solid '+BR,borderRadius:14,padding:'18px 20px'}}><div style={{fontSize:26,fontWeight:800,color:'#F59E0B'}}>{loading?'...':items.filter((r:any)=>r.status==='معلق').length}</div><div style={{fontSize:13,color:'rgba(255,255,255,0.5)',marginTop:4}}>معلقة</div></div><div key={'موافق عليها'} style={{background:CB,border:'1px solid '+BR,borderRadius:14,padding:'18px 20px'}}><div style={{fontSize:26,fontWeight:800,color:'#10B981'}}>{loading?'...':items.filter((r:any)=>r.status==='موافق').length}</div><div style={{fontSize:13,color:'rgba(255,255,255,0.5)',marginTop:4}}>موافق عليها</div></div><div key={'مرفوضة'} style={{background:CB,border:'1px solid '+BR,borderRadius:14,padding:'18px 20px'}}><div style={{fontSize:26,fontWeight:800,color:'#EF4444'}}>{loading?'...':items.filter((r:any)=>r.status==='مرفوض').length}</div><div style={{fontSize:13,color:'rgba(255,255,255,0.5)',marginTop:4}}>مرفوضة</div></div>
 </div>

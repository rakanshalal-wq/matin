...
export default function EmergenciesPage() {
 ...
 <div>
 <h1 className="page-title"><IconRenderer name="ICON_Ambulance" size={18} /> الحالات الطارئة</h1>
 ...
 {[
 { label: 'إجمالي الحالات', value: stats.total, icon: "ICON_Ambulance", color: 'var(--gold)' },

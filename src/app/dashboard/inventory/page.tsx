...
export default function InventoryPage() {
 ...
 {[{ l: 'اجمالي الاصناف', v: items.length, c: GOLD, i: "ICON_Package" }, { l: 'مخزون كافي', v: items.length - lowStock.length, c: '#10B981', i: "ICON_CheckCircle" }, { l: 'مخزون منخفض', v: lowStock.length, c: '#F59E0B', i: 'Alert<Triangle size={16} />' }, { l: 'اجمالي القيمة', v: items.reduce((s: number, r: any) => s + (Number(r.price || 0) * Number(r.quantity || 0)), 0).toFixed(0) + ' ر.س', c: '#3B82F6', i: "ICON_Coins" }].map((s, i) => (

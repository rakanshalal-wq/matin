...
export default function AdsPage() {
 ...
 const positionLabels: Record<string, string> = { top: 'أعلى الصفحة', bottom: 'أسفل الصفحة', sidebar: 'الشريط الجانبي', all: 'Globe في كل مكان' };
 ...
 <span style={{ color: '#6B7280', fontSize: 12 }}>{(ad.views || 0).toLocaleString()}</span>
 <span style={{ color: '#6B7280', fontSize: 12 }}><Mouse size={16} /> {(ad.clicks || 0).toLocaleString()}</span>
 </div>

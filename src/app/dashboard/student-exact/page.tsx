...
// ═══════════════════════════════════════════════════════════════
// لوحة الطالب - بالضبط كما في الملف الأصلي
// ═══════════════════════════════════════════════════════════════
...
export default function StudentDashboard() {
  ...
  const styles = `
    :root {
      ...
      --primary-dim:rgba(96,165,250,0.1); --primary-border:rgba(96,165,250,0.22);
      --gold:#D4A843;
    ...
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .student-card{background:var(--primary-dim);border:1px solid var(--primary-border);border-radius:9px;padding:9px 11px;display:flex;align-items:center;gap:9px;}
    .student-av{width:32px;height:32px;border-radius:8px;background:rgba(96,165,250,0.15);border:1px solid var(--primary-border);display:flex;align-items:center;justify-content:center;font-size:16px;}
    .student-name{color:var(--text);font-size:12.5px;font-weight:700;}
    .student-role{color:var(--primary);font-size:10.5px;font-weight:600;}
    ...
    .user-av{width:28px;height:28px;border-radius:7px;background:rgba(96,165,250,0.1);border:1.5px solid rgba(96,165,250,0.3);display:flex;align-items:center;justify-content:center;font-size:14px;}
    ...
    .schedule-card{background:var(--bg-card);border:1px solid var(--border);border-radius:11px;padding:14px;margin-bottom:16px;}
    .schedule-title{font-size:13px;font-weight:700;color:var(--text);margin-bottom:12px;}
    .schedule-item{display:flex;align-items:center;gap:12px;padding:10px 0;border-bottom:1px solid var(--border2);}
    .schedule-item:last-child{border-bottom:none;}
    .time{width:70px;font-size:11px;color:var(--text-muted);font-weight:600;}
    .subject{flex:1;}
    .subject-name{font-size:13px;font-weight:700;color:var(--text);}
    .subject-room{font-size:11px;color:var(--text-muted);}
    .status{width:8px;height:8px;border-radius:50%;}
    .status.now{background:var(--green);box-shadow:0 0 6px var(--green);}
    .status.next{background:var(--text-muted);}
  ...
  const schedule = [
    { time: '08:00', subject: 'الرياضيات', room: 'فصل 101', status: 'now' },
    { time: '09:00', subject: 'الفيزياء', room: 'معمل 3', status: 'next' },
    { time: '10:00', subject: 'اللغة العربية', room: 'فصل 205', status: 'next' },
  ];
      ...
      <div dir="rtl" style={{ fontFamily: 'IBM Plex Sans Arabic, sans-serif', background: '#06060E', color: '#EEEEF5', height: '100vh', overflow: 'hidden', display: 'flex' }}>
        ...
        \u003cmain className="main">
          ...
          \u003cheader className="header">
            \u003cdiv>
              \u003cdiv className="hdr-title">لوحة الطالب\u003c/div>

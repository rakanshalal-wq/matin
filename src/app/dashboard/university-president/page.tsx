export default function Dashboard() {
  const stats = [{"label":"الكليات","color":"#3B82F6","value":"12"},{"label":"الطلاب","color":"#60A5FA","value":"25K"},{"label":"أعضاء هيئة التدريس","color":"#A78BFA","value":"850"},{"label":"الموظفون","color":"#D4A843","value":"1,200"}];
  return (
      ...
      \u003caside style={{ width: 260, flexShrink: 0, height: '100vh', background: '#08081A', borderLeft: '1px solid rgba(255,255,255,0.07)', display: 'flex', flexDirection: 'column' }}>
        ...
        \u003cnav style={{ flex: 1, padding: '6px 0' }}\u003e
          {['النظرة العامة', 'الكليات', 'الطلاب', 'الهيئة', 'المناهج', 'البحث'].map((item, i) => (
            \u003cdiv key={i} style={{ padding: '8px 16px', fontSize: 12, color: i === 0 ? '#EEEEF5' : 'rgba(238,238,245,0.55)', cursor: 'pointer', borderRight: i === 0 ? '3px solid #1E40AF' : 'none', background: i === 0 ? '#1E40AF20' : 'transparent' }}\u003e{item}\u003c/div\u003e
          ))}
        \u003c/nav\u003e
      \u003c/aside\u003e
      \u003cmain style={{ flex: 1, padding: 24 }}\u003e
        \u003ch1 style={{ fontSize: 24, fontWeight: 800, color: '#1E40AF', marginBottom: 24 }}\u003eلوحة رئيس الجامعة\u003c/h1\u003e

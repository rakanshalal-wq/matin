 ...
 * يُرجى الانتقال إلى /dashboard/quran-teacher للإصدار الكامل المرتبط بالـ API.
 */
export default function RedirectPage() {
  const router = useRouter();
  useEffect(() => {
    router.replace('/dashboard/quran-teacher');
  }, [router]);
  ...
  return (
    <div dir="rtl" style={{
      ...
      <div style={{ fontSize: 13, color: 'rgba(238,238,245,0.5)' }}>
        ...
        <a href="/dashboard/quran-teacher" style={{ color: '#C9A84C' }}>انقر هنا</a>
      </div>
    </div>
  );
}

...
export default function TaxesPage() {
 ...
 <div style={{ width: 64, height: 64, borderRadius: 18, background: 'rgba(201,162,39,0.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 12px' }}><Building2 size={28} color="#D4A843" /></div>

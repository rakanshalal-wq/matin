          ...
          {pages.map(page => (
            <div key={page.id} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 20 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                ...
                <span style={{ background: page.is_published ? 'rgba(34,197,94,0.2)' : 'rgba(239,68,68,0.2)', color: page.is_published ? '#22C55E' : '#EF4444', fontSize: 12, fontWeight: 700, padding: '4px 10px', borderRadius: 20 }}>{page.is_published ? 'CheckCircle منشور' : '<IconRenderer name="ICON_Star" size={18} /> مخفي'}</span>
              </div>

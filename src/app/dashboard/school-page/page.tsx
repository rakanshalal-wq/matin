  ...
  return (
    <div style={{ fontFamily: 'IBM Plex Sans Arabic, sans-serif', direction: 'rtl' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
        <div>
          <h1 style={{ fontSize: 28, fontWeight: 800, color: 'white', margin: 0 }}>School صفحة المدرسة</h1>
          <p style={{ color: 'rgba(255,255,255,0.6)', marginTop: 8 }}>تخصيص الصفحة العامة لمدرستك</p>
        </div>
        <button onClick={() => setShowAdd(true)} style={{ background: 'linear-gradient(135deg, #C9A227, #D4B03D)', color: '#06060E', padding: '12px 24px', borderRadius: 10, border: 'none', fontWeight: 700, cursor: 'pointer' }}>Plus إنشاء صفحة</button>
      </div>
      ...
      {loading ? (
        ...
        <div style={{ textAlign: 'center', padding: 60 }}>
          <div style={{ fontSize: 64, marginBottom: 16 }}>School</div>
          ...
          {pages.map(page => (
            <div key={page.id} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 20 }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <button onClick={() => openEditor(page)} style={{ flex: 1, background: 'rgba(201,162,39,0.1)', color: '#C9A227', border: '1px solid rgba(201,162,39,0.3)', borderRadius: 8, padding: '8px', fontSize: 13, fontWeight: 700, cursor: 'pointer' }}>Pencil️ تعديل</button>
                <a href={`/school/${page.slug}`} target="_blank" rel="noreferrer" style={{ flex: 1, background: 'rgba(59,130,246,0.1)', color: '#3B82F6', border: '1px solid rgba(59,130,246,0.3)', borderRadius: 8, padding: '8px', fontSize: 13, fontWeight: 700, cursor: 'pointer', textDecoration: 'none', textAlign: 'center' }}>Eye️ معاينة</a>
              </div>
            </div>
          ))}
        </div>
        ...
        <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
            ...
            <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 24 }}>
              <h3 style={{ color: '#C9A227', fontWeight: 700, marginBottom: 20 }}>FileText المعلومات الأساسية</h3>
              {[
            ...
            <div>
              <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 24, marginBottom: 20 }}>
                <h3 style={{ color: '#C9A227', fontWeight: 700, marginBottom: 20 }}>Phone معلومات التواصل</h3>
                {[
              ...
              <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 24, marginBottom: 20 }}>
                <h3 style={{ color: '#C9A227', fontWeight: 700, marginBottom: 20 }}>Smartphone التواصل الاجتماعي</h3>
                {[
              ...
              <div style={{ display: 'flex', gap: 12 }}>
                ...
                <a href={`/school/${selected.slug}`} target="_blank" rel="noreferrer" style={{ background: 'rgba(59,130,246,0.1)', color: '#3B82F6', border: '1px solid rgba(59,130,246,0.3)', borderRadius: 12, padding: '14px 20px', fontSize: 14, fontWeight: 700, textDecoration: 'none', display: 'flex', alignItems: 'center' }}>Eye️ معاينة</a>
              </div>
            </div>
          </div>
        </div>
      ...
      {showAdd && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: 20 }}>
          <div style={{ background: '#1B263B', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 20, padding: 32, width: '100%', maxWidth: 440 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
              <h2 style={{ color: 'white', fontWeight: 800, margin: 0 }}>School إنشاء صفحة جديدة</h2>

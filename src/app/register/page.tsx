          ...
          {step === 1 ? (
            <div>
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <select value={form.institution_type} onChange={e => setForm({...form, institution_type: e.target.value})} style={{ ...inputStyle, cursor: 'pointer', backgroundColor: '#0B0B16' }}>
                  <option value="school" style={{ background: '#0B0B16', color: '#EEEEF5' }}>مدرسة</option>
                  <option value="university" style={{ background: '#0B0B16', color: '#EEEEF5' }}>جامعة</option>
            ...
            <div>
              ...
              <div style={{ marginBottom: 20 }}>
                ...
                <select value={form.plan} onChange={e => setForm({...form, plan: e.target.value})} style={{ ...inputStyle, cursor: 'pointer', backgroundColor: '#0B0B16' }}>
                  <option value="free" style={{ background: '#0B0B16', color: '#EEEEF5' }}>مجانية</option>
                  <option value="basic" style={{ background: '#0B0B16', color: '#EEEEF5' }}>أساسية</option>
                  <option value="pro" style={{ background: '#0B0B16', color: '#EEEEF5' }}>احترافية</option>
                  <option value="enterprise" style={{ background: '#0B0B16', color: '#EEEEF5' }}>مؤسسية</option>
                </select>
              </div>

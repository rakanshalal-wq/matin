      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 60 }}>
          ...
          <h1 style={{ fontSize: 48, fontWeight: 900, color: 'white', marginBottom: 20 }}>
            الصحة <span style={{ color: '#C9A227' }}>المدرسية</span>
          </h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 32, marginBottom: 60 }}>
          {[
            { icon: '📋', title: 'الملف الصحي', desc: 'ملف صحي رقمي لكل طالب' },
            { icon: '💉', title: 'جدول التطعيمات', desc: 'تذكير بمواعيد التطعيمات' },
            { icon: '🚨', title: 'حالات الطوارئ', desc: 'معلومات الاتصال السريع' },
            { icon: '🩺', title: 'زيارات العيادة', desc: 'سجل زيارات الطلاب للعيادة' },
            { icon: '💊', title: 'الأدوية', desc: 'متابعة الأدوية المزمنة' },
            { icon: '📊', title: 'التقارير الصحية', desc: 'إحصائيات وتقارير شاملة' }
          ].map((item, i) => (

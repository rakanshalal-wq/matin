    ...
    <div style={{ background: '#06060E', minHeight: '100vh', color: '#EEEEF5', fontFamily: "'IBM Plex Sans Arabic', 'Tajawal', sans-serif", direction: 'rtl', overflowX: 'hidden' }}>
      <style>{`
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .hero-glow { position:absolute; top:-200px; left:50%; transform:translateX(-50%); width:1100px; height:700px; background:radial-gradient(ellipse, rgba(59,130,246,0.12) 0%, rgba(201,168,76,0.08) 40%, transparent 70%); pointer-events:none; z-index:0; }
        .hero-badge { display:inline-flex; align-items:center; gap:8px; background:rgba(59,130,246,0.08); border:1px solid rgba(59,130,246,0.2); color:#3B82F6; padding:6px 16px; border-radius:100px; font-size:12.5px; font-weight:600; margin-bottom:40px; }
      ...
      <section className="hero">
        ...
        <div style={{ position:'relative', zIndex:1 }}>
          <div className="hero-badge"><span className="badge-dot"></span>الحضور والغياب</div>
          <h1>تتبع الحضور بدقة<span className="gold">وإشعارات فورية للأهل</span></h1>
          <p>نظام حضور وغياب ذكي — تسجيل بالبصمة أو QR أو يدوي، مع إشعار واتساب فوري لولي الأمر عند غياب ابنه.</p>
        </div>
      </section>
      <div className="divider"></div>
      <section className="section">
        <div className="section-label">المميزات الكاملة</div>
        <div className="section-title">نظام حضور ذكي ودقيق</div>
        <div className="section-desc">تسجيل الحضور بأسرع طريقة وأدق نتيجة — لا أخطاء، لا تلاعب، لا تأخير.</div>
        <div className="features-grid">
          {[
            { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#3B82F6" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M20 3H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1z M8 21h8 M12 17v4"/></svg>, title: 'تسجيل بمسح QR', desc: 'كل طالب يمسح QR الخاص به عند الدخول — سريع، دقيق، ولا يحتاج معلم.', color: 'rgba(59,130,246,0.12)' },
            { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#3B82F6" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9 M13.73 21a2 2 0 0 1-3.46 0"/></svg>, title: 'إشعار واتساب فوري', desc: 'ولي الأمر يستلم رسالة واتساب فوراً عند غياب ابنه أو تأخره — بدون أي تأخير.', color: 'rgba(59,130,246,0.12)' },
            { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#3B82F6" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M18 20V10 M12 20V4 M6 20v-6"/></svg>, title: 'تقارير الحضور', desc: 'تقارير يومية وأسبوعية وشهرية لكل طالب وكل فصل — نسب الحضور والغياب والتأخر.', color: 'rgba(201,168,76,0.12)' },
            { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#D4A843" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z M12 9v4 M12 17h.01"/></svg>, title: 'تنبيهات الغياب المتكرر', desc: 'تنبيه تلقائي للإدارة عند تجاوز الطالب حد الغياب المسموح به حسب اللوائح.', color: 'rgba(201,168,76,0.12)' },
            { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#D4A843" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7 M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>, title: 'تعديل الحضور', desc: 'المعلم يعدل الحضور بسهولة مع حفظ سجل التعديلات وسبب كل تعديل.', color: 'rgba(201,168,76,0.12)' },
            { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#D4A843" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M8 2v4 M16 2v4 M3 10h18 M21 8H3a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V9a1 1 0 0 0-1-1z"/></svg>, title: 'إجازات وأعذار', desc: 'تسجيل الإجازات والأعذار الرسمية مع ربطها بسجل الحضور تلقائياً.', color: 'rgba(201,168,76,0.12)' },
          ].map((f, i) => (
      ...
      <section className="cta-section">
        <div className="cta-box">
          ...
          <h2 style={{ fontSize:'32px', fontWeight:900, marginBottom:'16px' }}>لا غياب يمر دون علم</h2>
          <p style={{ fontSize:'15px', color:'var(--text-2)', lineHeight:1.7 }}>نظام الحضور في متين يضمن أن كل غياب يُرصد ويُبلَّغ عنه فوراً لأولياء الأمور.</p>

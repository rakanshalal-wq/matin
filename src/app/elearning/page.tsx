    ...
    <div style={{ background: '#06060E', minHeight: '100vh', color: '#EEEEF5', fontFamily: "'IBM Plex Sans Arabic', 'Tajawal', sans-serif", direction: 'rtl', overflowX: 'hidden' }}>
      ...
      <section className="section">
        ...
        <div className="features-grid">
          {[
            { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#3B82F6" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M23 7l-7 5 7 5V7z M1 5h15a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H1a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2z"/></svg>, title: 'فصول افتراضية مباشرة', desc: 'بث مباشر للدروس مع تسجيل تلقائي — الطالب الغائب يشاهد الدرس لاحقاً بنفس الجودة.', color: 'rgba(16,185,129,0.12)' },
            { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#3B82F6" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M23 7l-7 5 7 5V7z M1 5h15a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H1a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2z"/></svg>, title: 'مكتبة الفيديوهات', desc: 'رفع وتنظيم الفيديوهات التعليمية حسب المادة والوحدة — متاحة للطلاب في أي وقت.', color: 'rgba(16,185,129,0.12)' },
            { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#D4A843" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2 M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2 M9 14l2 2 4-4"/></svg>, title: 'الواجبات الإلكترونية', desc: 'تسليم الواجبات رقمياً — الطالب يرفع الحل، المعلم يصحح ويرسل الملاحظات مباشرة.', color: 'rgba(201,168,76,0.12)' },
            { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#3B82F6" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20z M12 8v4l3 3"/></svg>, title: 'مسارات تعلم بالذكاء الاصطناعي', desc: 'AI يحلل أداء كل طالب ويقترح محتوى مخصصاً لتعزيز نقاط الضعف وتطوير نقاط القوة.', color: 'rgba(201,168,76,0.12)' },
            { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#3B82F6" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>, title: 'منتدى الفصل', desc: 'منتدى نقاش لكل فصل — الطلاب يطرحون الأسئلة، المعلم يجيب، والجميع يستفيد.', color: 'rgba(201,168,76,0.12)' },
            { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#D4A843" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M12 15a6 6 0 1 0 0-12 6 6 0 0 0 0 12z M8.21 13.89L7 23l5-3 5 3-1.21-9.12"/></svg>, title: 'نظام الإنجازات', desc: 'شارات وإنجازات رقمية تحفز الطلاب على الإنجاز والمشاركة الفعالة في التعلم.', color: 'rgba(201,168,76,0.12)' },
            { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#3B82F6" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M18 20V10 M12 20V4 M6 20v-6"/></svg>, title: 'تحليلات التعلم', desc: 'تقارير تفصيلية عن تقدم كل طالب — وقت الدراسة، المحتوى المشاهد، ومعدل الإنجاز.', color: 'rgba(201,168,76,0.12)' },
            { icon: <svg width={20} height={20} viewBox="0 0 24 24" fill="none" stroke="#3B82F6" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round"><path d="M20 3H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1z M8 21h8 M12 17v4"/></svg>, title: 'متوافق مع الجوال', desc: 'تجربة تعلم سلسة من أي جهاز — جوال، تابلت، أو حاسوب — بدون أي فقدان للمحتوى.', color: 'rgba(201,168,76,0.12)' },
          ].map((f, i) => (

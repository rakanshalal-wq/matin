        ...
        <section style={{ padding: '80px 24px', textAlign: 'center' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <h1 style={{ fontSize: 56, fontWeight: 900, color: 'white', marginBottom: 20 }}>
              الأنشطة <span style={{ color: '#C9A227' }}>والفعاليات</span>
            </h1>
            <p style={{ fontSize: 22, color: 'rgba(255, 255, 255, 0.8)', marginBottom: 40 }}>
              نظام متكامل لإدارة الأنشطة اللاصفية والنوادي والمسابقات والرحلات
            </p>
          </div>
        </section>
        ...
        <section style={{ padding: '60px 24px' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 32 }}>
              {[
                { icon: '🎪', title: 'النوادي الطلابية', desc: 'إدارة النوادي المختلفة مع التسجيل الإلكتروني وجداول الاجتماعات' },
                { icon: '⚽', title: 'الأنشطة الرياضية', desc: 'تنظيم البطولات والمباريات الرياضية مع الجداول والنتائج' },
                { icon: '🎨', title: 'الأنشطة الثقافية', desc: 'المسرح، الرسم، الموسيقى، والفنون التشكيلية' },
                { icon: '🏆', title: 'المسابقات', desc: 'تنظيم المسابقات الأكاديمية والعلمية والثقافية' },
                { icon: '🚌', title: 'الرحلات الميدانية', desc: 'تخطيط وإدارة الرحلات التعليمية والترفيهية' },
                { icon: '📅', title: 'التقويم السنوي', desc: 'جدول شامل لجميع الفعاليات والمناسبات' },
                { icon: '📝', title: 'التسجيل الإلكتروني', desc: 'تسجيل سهل وسريع للطلاب في الأنشطة المختلفة' },
                { icon: '📸', title: 'ألبوم الفعاليات', desc: 'أرشفة صور وفيديوهات الأنشطة والفعاليات' }
              ].map((f, i) => (
        ...
        <section style={{ padding: '80px 24px', background: 'rgba(201, 162, 39, 0.05)' }}>
          <div style={{ maxWidth: 1200, margin: '0 auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: 32 }}>
              {[
                { num: '1', title: 'إنشاء الأنشطة', desc: 'أضف الأنشطة والنوادي' },
                { num: '2', title: 'التسجيل', desc: 'الطلاب يسجلون إلكترونياً' },
                { num: '3', title: 'المتابعة', desc: 'متابعة الحضور والمشاركة' },
                { num: '4', title: 'التقييم', desc: 'تقييم وشهادات المشاركة' }
              ].map((s, i) => (
        ...
        <section style={{ padding: '80px 24px', background: 'rgba(201, 162, 39, 0.05)', textAlign: 'center' }}>
          <div style={{ maxWidth: 800, margin: '0 auto' }}>
            ...
            <p style={{ fontSize: 20, color: 'rgba(255, 255, 255, 0.8)', marginBottom: 32 }}>
              ابدأ تجربتك المجانية الآن واكتشف كيف يمكن لمتين إثراء الأنشطة اللاصفية
            </p>

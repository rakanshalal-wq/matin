...
const SERVICES = [
  {
    ...
    items: [
      { title: 'إدارة البرامج التدريبية',   desc: 'تصميم وإدارة البرامج التدريبية مع تحديد الأهداف والمخرجات والمدة الزمنية.',                              href: '/dashboard/training',      color: '#3B82F6' },
      { title: 'إدارة الدورات',             desc: 'إنشاء وإدارة الدورات التدريبية مع تحديد المحتوى والجداول والمدربين.',                                    href: '/dashboard/courses',       color: '#8B5CF6' },
      { title: 'جداول التدريب',             desc: 'تنظيم جداول الدورات والجلسات التدريبية مع تجنب التعارضات وإدارة القاعات.',                               href: '/dashboard/schedules',     color: '#06B6D4' },
      { title: 'إدارة المتدربين',           desc: 'ملفات شاملة للمتدربين تشمل سجل الدورات، الشهادات، وتقييمات الأداء.',                                    href: '/dashboard/students',      color: '#10B981' },
      { title: 'الحضور والغياب',            desc: 'تسجيل حضور المتدربين بالباركود أو البصمة مع تقارير الانتظام.',                                           href: '/dashboard/attendance',    color: '#F59E0B' },
      { title: 'إدارة المدربين',            desc: 'ملفات المدربين، تخصصاتهم، تقييماتهم، وجداول جلساتهم التدريبية.',                                         href: '/dashboard/trainers',      color: '#F97316' },
    ]
  },
  {
    category: 'التعليم الإلكتروني',
    items: [
      { title: 'المحتوى الرقمي',            desc: 'رفع وتنظيم المحتوى التدريبي من فيديوهات وملفات ومواد تفاعلية.',                                          href: '/dashboard/lectures',      color: '#6366F1' },
      { title: 'البث المباشر',              desc: 'جلسات تدريبية مباشرة عبر الإنترنت مع أدوات تفاعلية وتسجيل تلقائي.',                                      href: '/dashboard/live-stream',   color: '#EF4444' },
      { title: 'الاختبارات والتقييم',       desc: 'اختبارات قبلية وبعدية لقياس مستوى المتدربين مع تقارير تحليلية.',                                          href: '/dashboard/exams',         color: '#A855F7' },
      { title: 'الواجبات والمشاريع',        desc: 'توزيع ومتابعة المشاريع التطبيقية والواجبات العملية للمتدربين.',                                            href: '/dashboard/homework',      color: '#EC4899' },
      { title: 'بنك الأسئلة',              desc: 'مكتبة أسئلة مصنفة حسب البرنامج والمستوى مع توليد اختبارات تلقائي.',                                      href: '/dashboard/question-bank', color: '#14B8A6' },
      { title: 'الفيديوهات التعليمية',      desc: 'مكتبة فيديو تدريبية منظمة مع إمكانية التعليق والنقاش والتقييم.',                                         href: '/dashboard/videos',        color: '#22D3EE' },
    ]
  },
  {
    category: 'الشهادات والاعتماد',
    items: [
      { title: 'إصدار الشهادات',            desc: 'إصدار شهادات إتمام الدورات إلكترونياً مع رمز QR للتحقق الفوري.',                                          href: '/dashboard/certificates',  color: '#10B981' },
      { title: 'الاعتماد والجودة',          desc: 'إدارة متطلبات الاعتماد من الجهات المختصة وتوثيق معايير الجودة.',                                           href: '/dashboard/reports',       color: '#F59E0B' },
      { title: 'سجل الإنجازات',             desc: 'سجل رقمي شامل لإنجازات المتدرب وشهاداته وساعاته التدريبية.',                                              href: '/dashboard/student',       color: '#8B5CF6' },
    ]
  },
  {
    category: 'التسويق والمبيعات',
    items: [
      { title: 'إدارة العملاء المحتملين',   desc: 'تتبع العملاء المحتملين وتحويلهم إلى مشتركين مع أدوات CRM متكاملة.',                                       href: '/dashboard/leads',         color: '#3B82F6' },
      { title: 'الكوبونات والعروض',         desc: 'إنشاء كوبونات خصم وعروض ترويجية لجذب المتدربين وزيادة الإيرادات.',                                        href: '/dashboard/coupons',       color: '#EC4899' },
      { title: 'برنامج الإحالة',            desc: 'نظام إحالة مكافآت يشجع المتدربين على دعوة زملائهم للانضمام.',                                              href: '/dashboard/referrals',     color: '#F97316' },
      { title: 'الشركاء والعمولات',         desc: 'إدارة شركاء التسويق وتتبع العمولات وإصدار تقارير الأداء.',                                                 href: '/dashboard/commissions',   color: '#84CC16' },
      { title: 'الإعلانات الداخلية',        desc: 'إدارة الإعلانات والبانرات داخل المنصة للترويج للدورات الجديدة.',                                           href: '/dashboard/advertisements', color: '#60A5FA' },
    ]
  },
  {
    ...
    items: [
      ...
      { title: 'إدارة العقود',              desc: 'عقود إلكترونية مع المدربين والشركاء والعملاء مع توقيع رقمي.',                                              href: '/dashboard/contracts',     color: '#A78BFA' },
      { title: 'إدارة المرافق',             desc: 'حجز قاعات التدريب والمعدات مع جدولة الصيانة الدورية.',                                                    href: '/dashboard/facilities',    color: '#FBBF24' },
      { title: 'المتجر الإلكتروني',         desc: 'بيع الكتب والمواد التدريبية والمستلزمات إلكترونياً.',                                                      href: '/dashboard/store',         color: '#38BDF8' },
    ]
  },
  {
    category: 'الذكاء الاصطناعي',
    items: [
      { title: 'المساعد الذكي للتدريب',     desc: 'مساعد AI يساعد المدربين في إعداد المحتوى والاختبارات وتحليل أداء المتدربين.',                              href: '/dashboard/ai-chat',       color: '#A78BFA' },
      { title: 'تحليلات الأداء',            desc: 'رؤى ذكية عن أداء المتدربين والبرامج ومعدلات الإتمام بالذكاء الاصطناعي.',                                  href: '/dashboard/reports',       color: '#60A5FA' },
      { title: 'توليد المحتوى التلقائي',    desc: 'توليد اختبارات ومواد تدريبية تلقائياً من المحتوى المرفوع بالذكاء الاصطناعي.',                              href: '/dashboard/question-analytics', color: '#F472B6' },
    ]
  },
];
...
const INTEGRATIONS = [
  ...
  { name: 'Zoom',    desc: 'جلسات تدريبية مباشرة' },
];

const STATS = [
  { value: '+٢٠٠', label: 'مركز تدريب يثق بمتين' },
  { value: '+٥٠ألف', label: 'متدرب مسجل' },
  { value: '٩٩.٩٪', label: 'وقت تشغيل مضمون' },
  { value: '+٤٥', label: 'خدمة متكاملة' },
];
...
const PLANS = [
  {
    ...
    price: '٤٩٩',
    period: 'شهرياً',
    desc: 'مثالية لمراكز التدريب الصغيرة',
    features: ['حتى ٢٠٠ متدرب', 'إدارة الدورات والجداول', 'الحضور والغياب', 'إصدار الشهادات', 'دعم فني'],
    href: '/register?type=training&plan=basic',
    popular: false,
  },
  {
    name: 'الاحترافية',
    price: '٩٩٩',
    period: 'شهرياً',
    desc: 'الأكثر شعبية لمراكز التدريب المتوسطة',
    features: ['حتى ١٠٠٠ متدرب', 'كل ميزات الأساسية', 'التعليم الإلكتروني والبث المباشر', 'التسويق والكوبونات', 'إدارة العقود', 'تكامل واتساب', 'دعم أولوية'],
    href: '/register?type=training&plan=pro',
    popular: true,
  },
  {
    name: 'المؤسسية',
    price: 'تواصل معنا',
    period: '',
    desc: 'لمجموعات التدريب والشركات الكبيرة',
    features: ['متدربون غير محدودون', 'كل الميزات', 'المساعد الذكي AI', 'برنامج الإحالة والشركاء', 'تقارير متقدمة', 'مدير حساب مخصص', 'SLA مضمون ٩٩.٩٪'],
    href: '/contact',
    popular: false,
  },
];
...
const FAQ = [
  { q: 'هل يمكن إصدار شهادات معتمدة إلكترونياً؟', a: 'نعم، يوفر النظام إصدار شهادات إلكترونية مع رمز QR للتحقق الفوري، ويمكن تخصيص تصميم الشهادة بشعار مركزك.' },
  { q: 'هل يدعم النظام التدريب عن بعد والحضوري معاً؟', a: 'نعم، يدعم النظام نماذج التدريب الثلاثة: الحضوري، عن بعد، والهجين مع أدوات متكاملة لكل نموذج.' },
  { q: 'كيف يتم تتبع أداء المتدربين؟', a: 'يوفر النظام لوحة تحليلات شاملة تتتبع معدلات الإتمام، نتائج الاختبارات، ومعدل الحضور مع تقارير مفصلة لكل متدرب.' },
  { q: 'هل يمكن ربط المنصة بأنظمة الموارد البشرية للشركات؟', a: 'نعم، نوفر واجهات برمجية للتكامل مع أنظمة الموارد البشرية وأنظمة ERP للشركات الكبيرة.' },
  { q: 'هل يدعم النظام برامج التدريب الحكومية؟', a: 'نعم، النظام متوافق مع متطلبات المؤسسة العامة للتدريب التقني والمهني وهيئة تقييم التعليم والتدريب.' },
];

export default function TrainingPage() {
  const [activeCategory, setActiveCategory] = useState('إدارة البرامج');
    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-badge { display: inline-flex; align-items: center; gap: 8px; background: rgba(59,130,246,0.08); border: 1px solid rgba(59,130,246,0.2); color: #60A5FA; padding: 6px 16px; border-radius: 100px; font-size: 12.5px; font-weight: 600; margin-bottom: 40px; }
        ...
        .cta-glow { position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 800px; height: 400px; background: radial-gradient(ellipse, rgba(59,130,246,0.1) 0%, transparent 70%); pointer-events: none; }
      ...
      <nav className="nav">
        ...
        <div className="nav-links">
          ...
          <Link href="/kindergarten" className="nav-link">رياض الأطفال</Link>
          <Link href="/training" className="nav-link active">التدريب</Link>
        ...
        <div className="nav-actions">
          ...
          <Link href="/register?type=training" className="btn-primary">ابدأ مجاناً</Link>
        </div>
      </nav>
      ...
      <section className="hero">
        ...
        <div className="hero-inner">
          <div className="hero-badge fade-in">
            ...
            منصة إدارة مراكز التدريب الأولى في السعودية
          </div>
          <h1 className="fade-in">
            أدر مركزك التدريبي
            <span className="gold">بكفاءة واحترافية</span>
          </h1>
          <p className="hero-sub fade-in">
            منصة متين توفر لك أكثر من ٤٥ خدمة متكاملة لإدارة مركزك التدريبي — من إدارة الدورات والمتدربين إلى التسويق والشهادات والذكاء الاصطناعي، كل شيء في مكان واحد.
          </p>
          <div className="hero-btns fade-in">
            <Link href="/register?type=training" className="btn-hero">ابدأ تجربتك المجانية</Link>
      ...
      <section style={{ background: 'var(--dark-2)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)', padding: '100px 24px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div className="fade-in" style={{ textAlign: 'center', marginBottom: 48 }}>
            ...
            <h2 className="section-title">كل ما يحتاجه مركزك التدريبي<br /><span style={{ color: 'var(--gold-2)' }}>في منصة واحدة</span></h2>
            <p className="section-sub">أكثر من ٤٥ خدمة متكاملة مصممة خصيصاً لاحتياجات مراكز التدريب السعودية.</p>
          </div>
          <div className="tabs">
            {SERVICES.map(s => (
      ...
      <section style={{ background: 'var(--dark)', borderBottom: '1px solid var(--border)', padding: '80px 24px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div className="fade-in" style={{ textAlign: 'center' }}>
            ...
            <h2 className="section-title">متكامل مع أبرز المنصات<br /><span style={{ color: 'var(--gold-2)' }}>وبوابات الدفع المعتمدة</span></h2>
          </div>
      ...
      <section id="pricing" className="section">
        <div className="fade-in" style={{ textAlign: 'center' }}>
          ...
          <h2 className="section-title">خطط مرنة تناسب<br /><span style={{ color: 'var(--gold-2)' }}>كل حجم مركز تدريب</span></h2>
      ...
      <section style={{ background: 'var(--dark-2)', borderTop: '1px solid var(--border)', padding: '80px 24px' }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          <div className="fade-in" style={{ textAlign: 'center' }}>
            ...
            <h2 className="section-title">أسئلة يسألها<br /><span style={{ color: 'var(--gold-2)' }}>مديرو مراكز التدريب</span></h2>
          </div>
      ...
      <section className="cta-section">
        ...
        <div className="cta-inner fade-in">
          <h2 className="cta-title">ابدأ رحلة التحول الرقمي<br /><span style={{ color: 'var(--gold-2)' }}>لمركزك التدريبي اليوم</span></h2>
          <p className="cta-sub">انضم إلى أكثر من ٢٠٠ مركز تدريب يستخدم متين لإدارة عملياتها بكفاءة واحترافية.</p>

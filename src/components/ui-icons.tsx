// مكونات UI مشتركة تستخدمها الصفحات القديمة

// ─── الألوان الافتراضية ───
export const G = '#C9A84C';          // Gold
export const DARK = '#06060E';       // Dark background
...
export function Icon({ d, size = 20, color = 'currentColor', style }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function Spinner({ size = 24, color = '#C9A84C' }: SpinnerProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <circle cx="12" cy="12" r="10" stroke={color} strokeWidth="3" strokeDasharray="40 60" fill="none" />
    </svg>
  );
}

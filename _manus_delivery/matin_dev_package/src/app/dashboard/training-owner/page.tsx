...
export default function TrainingOwnerDashboard() {
 ...
 { label: 'العمولات', href: '/dashboard/commissions', color: 'var(--gold)', count: null },
 ...
 <Link href="/dashboard/courses" style={{ color: 'var(--gold)', fontSize: 11, textDecoration: 'none', fontWeight: 600 }}>عرض الكل</Link>
 </div>
 {courses.length === 0
 ...
 <Link href="/dashboard/leads" style={{ color: 'var(--gold)', fontSize: 11, textDecoration: 'none', fontWeight: 600 }}>عرض الكل</Link>
 </div>
 {leads.length === 0

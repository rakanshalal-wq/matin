...
export default function Page(){
 ...
 <div><h1 className="page-title"><IconRenderer name="ICON_Globe" size={18} /><IconRenderer name="ICON_Pin" size={18} /> تتبع الطلاب</h1><p className="page-sub">متابعة وتتبع الطلاب وحضورهم اليومي</p></div>

...
export default function HealthPage() {
 ...
 <div>
 <h1 className="page-title"><IconRenderer name="ICON_Hospital" size={18} /> السجلات الصحية</h1>
 ...
 {[
 { label: 'إجمالي السجلات', value: stats.total, icon: "ICON_Hospital", color: 'var(--gold)' },

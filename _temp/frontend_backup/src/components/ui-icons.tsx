// ─── Matin Design System — Icons & Shared Components ─────────────────────────
// Design: Dark #06060E + Gold #C9A84C — متين v5

export const G = '#C9A84C';
export const DARK = '#06060E';
...
export const ICONS: Record<string, string> = {
  ...
  grades:       'M18 20V10 M12 20V4 M6 20v-6',
  ...
  institutions: 'M3 21h18 M9 8h1 M9 12h1 M9 16h1 M14 8h1 M14 12h1 M14 16h1 M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16',
  ...
  community:    'M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2 M23 21v-2a4 4 0 0 0-3-3.87 M16 3.13a4 4 0 0 1 0 7.75',
  ...
  student_hat:  'M22 10v6M2 10l10-5 10 5-10 5z M6 12v5c3 3 9 3 12 0v-5',
...
export function Spinner({ size = 32, color = G }: { size?: number; color?: string }) {
  return (
    <>
      <style>{`@keyframes matin-spin { to { transform: rotate(360deg); } }`}</style>
      <div style={{ width: size, height: size, border: `3px solid ${color}`, borderTopColor: 'transparent', borderRadius: '50%', animation: 'matin-spin 0.8s linear infinite' }} />
    </>
  );
}

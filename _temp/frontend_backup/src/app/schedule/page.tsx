    ...
    <div style={{ background: '#06060E', minHeight: '100vh', color: '#EEEEF5', fontFamily: "'IBM Plex Sans Arabic', 'Tajawal', sans-serif", direction: 'rtl', overflowX: 'hidden' }}>
      ...
      <section className="hero">
        ...
        <div style={{ position:'relative', zIndex:1 }}>
          <div className="hero-badge"><span className="badge-dot"></span>الجدول الدراسي</div>
          <h1>جدول دراسي ذكي<span className="gold">بلا تعارضات</span></h1>
          <p>نظام إنشاء الجداول الدراسية الذكي — يراعي أوقات المعلمين، الفصول، والمواد تلقائياً بدون تعارضات.</p>
        </div>
      </section>
      <div className="divider"></div>
      <section className="section">
        <div className="section-label">المميزات الكاملة</div>
        <div className="section-title">جدول ذكي يوفر الوقت والجهد</div>
      ...
      <section className="cta-section">
        <div className="cta-box">
          ...
          <h2 style={{ fontSize:'32px', fontWeight:900, marginBottom:'16px' }}>جدول مثالي في دقائق</h2>
          <p style={{ fontSize:'15px', color:'var(--text-2)', lineHeight:1.7 }}>متين يحوّل إنشاء الجداول من مهمة تستغرق أياماً إلى عملية تلقائية في دقائق.</p>

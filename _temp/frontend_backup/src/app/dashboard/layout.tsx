...
export default function DashboardLayout({
 ...
 // ✅ توجيه المستخدمين المعلقين لصفحة الانتظار
 ...
 setUserRole(u.role || '');
 if (u.status === 'pending' && pathname !== '/dashboard/pending') {
   router.push('/dashboard/pending');
   return;
 }
 setLoading(false);
 ...
 // إذا كان المستخدم معلقاً وهو في صفحة الانتظار، لا نعرض الـ Sidebar والـ Header
